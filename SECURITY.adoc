...
[arabic]
. Navigate to
https://github.com/hyperpolymath/self-destructing-git-garbage/security/advisories/new[Report
a Vulnerability]
...
* This repository (`+hyperpolymath/self-destructing-git-garbage+`) and
all its code
...
https://github.com/hyperpolymath/self-destructing-git-garbage/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/self-destructing-git-garbage/discussions[GitHub
Discussions]
...
_Thank you for helping keep Self Destructing Git Garbage and its users
safe._ 🛡️
