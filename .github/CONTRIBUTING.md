...
git clone
<https://github.com/hyperpolymath/self-destructing-git-garbage.git> cd
...
toolbox create self-destructing-git-garbage-dev toolbox enter
self-destructing-git-garbage-dev \# Install dependencies manually
...
self-destructing-git-garbage/ ├── src/ \# Source code (Perimeter 1-2)
