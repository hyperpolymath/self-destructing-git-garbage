...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/self-destructing-git-garbage/security/advisories/new)
...
- This repository (`hyperpolymath/self-destructing-git-garbage`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/self-destructing-git-garbage/security/advisories)
...
When using Self Destructing Git Garbage, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/self-destructing-git-garbage/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/self-destructing-git-garbage/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/self-destructing-git-garbage/discussions) |
...
*Thank you for helping keep Self Destructing Git Garbage and its users safe.* 🛡️
